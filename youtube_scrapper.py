...
with sync_playwright() as playwright, playwright.chromium.launch(headless=False) as browser:
    ...
    try:
        ...
        response.search_input.type("learn javascript course", delay=75)
        ...
        # scroll down the page couple times to load more comments
        for _ in range(3):
    ...
    # for demo purposes, allows you to see the effect of the script
